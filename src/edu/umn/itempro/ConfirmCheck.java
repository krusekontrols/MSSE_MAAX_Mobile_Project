...
public class ConfirmCheck extends Activity{
	public static final String CHECK_ITEM_OFF = "edu.umn.itempro.action.CHECK_ITEM_OFF";
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        amount_unitText.setText(cursor.getString(cursor.getColumnIndex(Item.AMOUNT)));
