...
public class AddToList extends Activity{
	public static final String MODIFY_ITEM_STATUS = "edu.umn.itempro.action.MODIFY_ITEM_STATUS";
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        plusButton.setOnClickListener(new View.OnClickListener() {
        	public void onClick(View view) {
				...
				amountEdit.setText(ItemProProvider.format.format(amount));
				updateAmountUnit();
        ...
        cursor.moveToFirst();
        String name = cursor.getString(cursor.getColumnIndex(Item.NAME));
        nameText.setText(name);
        amountEdit.setText(cursor.getString(cursor.getColumnIndex(Item.AMOUNT)));
        unitEdit.setText(cursor.getString(cursor.getColumnIndex(Item.UNIT)));
    ...
    private void storeData(boolean onList){
        ...
        values.put(Item.AMOUNT, getAmount());
        values.put(Item.UNIT, unitEdit.getText().toString());
        values.put(Item.ONLIST, onList?1:0);
