...
public class EditCategories  extends ListActivity {
	...
	private void handleCreateClick(){
		Intent intent = new Intent(Intent.ACTION_INSERT, ItemProProvider.getContentURI(ItemProDatabase.TABLE_CATEGORY));
	...
	private void fillList() {
        ...
        SimpleCursorAdapter adapter = new SimpleCursorAdapter(this, R.layout.category, cursor, from, to);
    ...
    public void onCreateContextMenu(ContextMenu menu, View view, ContextMenuInfo menuInfo) {
        ...
        menu.setHeaderTitle(cursor.getString(cursor.getColumnIndex(Item.NAME)));
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case ITEM_DELETE: 
                ...
                return true;
            case ITEM_EDIT: 
            	Uri categoryUri = ContentUris.withAppendedId(ItemProProvider.getContentURI(ItemProDatabase.TABLE_CATEGORY), info.id);
    ...
    private void confirmDeleteCategory(){
        ...
        .setPositiveButton(R.string.ok_label, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int whichButton) {
            	Uri categoryUri = ContentUris.withAppendedId(ItemProProvider.getContentURI(ItemProDatabase.TABLE_CATEGORY), deleteID);
